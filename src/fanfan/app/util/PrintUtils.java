...
public class PrintUtils {
	...
	public static void feedAndCut() {
		try {
			if (outputStream != null) {
				...
				BlueUtils.getInstance().write(new byte[] { 0x1D, 86, 65, 100 });
			}
		} catch (IOException e) {
			// Toast.makeText(this.context, "发送失败！", Toast.LENGTH_SHORT).show();
			e.printStackTrace();
	 ...
	 * 切纸命令
	 */
	public static final byte[] CUTE_PAPER = { 0x1D, 0x56, 0x42, 0x00 };
	...
	public static final byte[] END = { 0x1D, 0x0C };

	/**
	 * 设置行间距
	 */
	// public static final byte[] LINE_SPACING = {0x1b, 0x32};//{0x1b, 0x33, 0x14};
	// // 20的行间距（0，255）
